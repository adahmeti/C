/*This program fills three arrats witha a plater's total points.
rebounds, and assists  It loops though the scoring array and finds the game with the most points.
Once it knows that information, it prints the totalts from all three categories from that game */

#include <stdio.h>

	int main(){

		int gameScores[10]={12,5,21,15,23,10,6,31,11,10};
		int gameRebounds[10]={5,7,1,5,10,3,0,7,6,4};
		int gameAssists[10]={2,9,4,3,6,1,11,6,9,10};
		int bestGame=0;//The comparison cariable for best scoring game
